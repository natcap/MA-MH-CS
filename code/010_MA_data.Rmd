...
## save for later use
f <- paste0('./data/0301-MA-input/', 'sub_coef_SF.rds')
...
## save for later use
f <- paste0('./data/0301-MA-input/', 'sub_coef_WW.rds')
saveRDS(exp_sub_df, file = f)
```
...
exp_sub_df <- func_exp_subset(df = df, exposure_type_i = exposure_type_i, mh_tool = mh_tool)
sub_pss_ros <- exp_sub_df

## save for later use
f <- paste0('./data/0301-MA-input/', 'sub_coef_pss_ros.rds')
saveRDS(exp_sub_df, file = f)
```
