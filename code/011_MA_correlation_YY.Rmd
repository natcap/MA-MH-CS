...
dir_share <- 'E:/R/meta_mental wellbeing/result/'
dir.fig <- "E:/R/meta_mental wellbeing/meta-analysis-nature-health-main (1)/meta-analysis-nature-health-main/code/figures"
...
f <- paste0('./figures/', 'forest_op1_L1_',postfix_subgroup_type,  today, '.png'); f
png(filename = f, 
...
f <- paste0('./figures/', 'forest_op1_L1_', postfix_subgroup_buffer, today, '.png')
...
f <- paste0('./figures/', 'forest_op1_L1_',postfix_subgroup_tool,  today, '.png'); f
png(filename = f, 
    # width = 3000, height = 3000, units = "px", pointsize = 22,
    width = width_forestPlot/2, height = height_cm/1.2, units = "cm", res = 100)
...
for (tool in mh_tools) {
  ...
  for (subgroup_select in subgroups) {
    ...
    # 数据处理
    ma_cor_op1_L1 <- dat_op1_L1_regr %>%
      #dplyr::filter(MH_tool == tools) %>%  # 筛选当前工具的数据
