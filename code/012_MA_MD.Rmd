...
fname <- paste0('./data/0302-MA-output/', 
                paste('ma_result.overall', paste(mh_tool, collapse = "_"), '.rds', sep = '_')); fname
saveRDS(ma_result.overall, file = fname)

if (add_subgroup_analysis == T) {
  fname <- paste0('./data/0302-MA-output/', 
                  paste('ma_result.subgroup', paste(mh_tool, collapse = "_"), subgroup_select, '.rds', sep = '_')); fname
...
fname <- paste0(dir.fig, 'es_combined_tool', length(mh_tool_list), '_', today, vv, 'v2.png'); fname
