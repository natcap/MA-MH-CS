...
f <- 'mini-review_nature exposure.png'
...
png(file=paste0('./figures/', 'plot_forest.png'), 
...
png(file=paste0('./figures/', 'plot_funnel.png'), 
    width = 1000, height = 1000, units = "px", pointsize = 22) 
funnel(
...
```{r }
### reporter() function
reporter(res, dir = paste0(dir.root, '/figures/'))
