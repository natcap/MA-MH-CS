...
f <- paste0('./figures/', 'plot_forest_cor_', today ,'.png'); f
png(file=f, 
...
if (add_subgroup_analysis == T) {
  ma_cor <- update(ma_cor, subgroup = subgroup_selected)
...
f <- paste0('./figures/', 'plot_forest_cor_meta_',postfix_subgroup,  today, '.png'); f
png(filename = f, 
    # width = 3000, height = 3000, units = "px", pointsize = 22,
    width = width_forestPlot/2, height = height_cm/2.2, units = "cm", res = 100)
