...
func_clean_tools <- function(data) {
  d <- data %>%
    dplyr::mutate(
      ...
      Tool = case_when(Tool %in% c('Digit', 'digit') ~ "Digit Span",
...
func_alluvial(data = dtt, indicator_n_min = 3, labele_small = 20, w_p = 10, filename.postfix = 'indicator_tool_region')
