...
func_ggsave <- function(fname, w = 7, h = 4) {
...
func_ggsave(fname = fname, w = 7, h = 4)
```
...
func_alluvial(data = dtt, indicator_n_min = 3, labele_small = 30, w_p = 10, filename.postfix = 'indicator_tool_region')
