...
fname <- paste0(dir.fig, 'es_comb_', today, vv, '.png'); fname
...
ind_sub_levels <- c("TMD", "Anxiety", "Fatigue", "Confusion", "Anger", "Depression",  
                    "Stress", "Negative Affect", 
                    "Positive Affect", "Restorative Effect", "Vigor")

p_all <- ma_result_all_sub %>%
...
fname <- paste0(dir.fig, 'es_comb_subgroup_', subgroup_select, '_', today, vv, '_ppt.png'); fname
func_ggsave(fname, w = 16/2, h = 9/2, save_png = T)
```
