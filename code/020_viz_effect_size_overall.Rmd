...
for (subgroup_select in subgroups) {
  ...
  p_comb <- 
    ggarrange(p1 + rremove("x.title"), 
              ...
              align = "v")
  p_comb
  fname <- paste0(dir.fig, 'es_comb', postfix_group, '_', today, vv, '.png'); fname
...
fname <- paste0(dir.fig, 'es_comb', postfix_group, '_', today, vv, '_.png'); fname
# func_ggsave(fname, w = 6, h = 5.5+1, save_png = T)
```
